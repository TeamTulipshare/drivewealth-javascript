					...
					return new Promise(function (resolve, reject) {
						...
						var checkStatus = function checkStatus() {
							...
							Promise.all(orderResults.map(function (order) {
								return new Promise(function (resolve, reject) {
									Order.getByID(order.orderID, userID).then(function (order) {
